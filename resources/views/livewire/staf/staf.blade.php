<div>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route("staf.add")}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <tbody>
                @foreach ($staf as $data)
                    <tr>
                        ...
                        <td>
                            <span class="fw-bold">{{ $data->transportasi }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span
                                class="fw-normal {{ $data->status_deactive_staf === 1 ? 'text-success' : 'text-danger' }}">
