<div>
  <title>{{ config('app.name', 'Laravel') }} - Edit Staf</title>
      ...
      <div>
        <form wire:submit.prevent="edit" action="#" class="mt-4" method="POST"> <!-- Form -->
          <div class="mb-3">
            ...
            <input value="{{ $nama }}" type="text" class="form-control" id="nama"
              placeholder="John Thooor" wire:model="nama">
            @error('nama')
          ...
          <div class="mb-3">
            ...
            <input value="{{ $noHp }}" type="number" class="form-control" id="phone"
              placeholder="08xxxxxxx" wire:model="noHp">
            @error('noHp')
              <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input value="{{ $jumlah_tugas }}" type="number" class="form-control" id="jumlah_tugas" placeholder="10"
              wire:model="jumlah_tugas">
            @error('jumlah_tugas')
              <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
