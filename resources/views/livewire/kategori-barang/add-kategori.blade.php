<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tambah kategori</h2>
        </div>
    </div>
            ...
            <div>
                <form wire:submit.prevent="store" class="mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" wire:model="hitung_berat">
                    ...
                    <div class="mb-3">
                        @if($hitung_berat === '1' || $hitung_berat === 1)
                            <label for="tarif_per_kg" class="form-label">Tarif per Kg</label>
                            <input type="number" step="0.01" class="form-control" id="tarif_per_kg"
                                placeholder="Contoh: 10000" wire:model="tarif_per_kg">
                        @endif
                        @error('tarif_per_kg')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" wire:model="hitung_volume">
                            <option value="">Pilih</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                    ...
                    <div class="mb-3">
                        @if($hitung_volume === '1' || $hitung_volume === 1)
                            <label for="tarif_per_m3" class="form-label">Tarif per m³</label>
                            <input type="number" step="0.01" class="form-control" id="tarif_per_m3"
                                placeholder="Contoh: 50000" wire:model="tarif_per_m3">
                        @endif
                        @error('tarif_per_m3')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="tarif_flat"
                            placeholder="Contoh: 20000" wire:model="tarif_flat">
                        @error('tarif_flat')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="biaya_tambahan"
                            placeholder="Contoh: 5000" wire:model="biaya_tambahan">
